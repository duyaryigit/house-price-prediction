...
##############################################################
# Step 1: Read and merge the Train and Test datasets. Proceed through the data you have combined.
##############################################################
...
# df["GarageYrBlt"] incorrectly entered max also change to 2207 - 2007
...
# Filling the null values in the columns with the expression "No"
for col in no_cols:
...
def quick_missing_imp(data, num_method="median", cat_length=20, target="SalePrice"):
    ...
    # If num_method is median, empty values of non-object type variables are filled with median
...
# Separate the Train and Test data. (Values with an empty SalePrice variable are test data.)
...
##################
# BONUS: Build a model by performing log conversion and observe the rmse results.
...
#Splitting the data into training and tet data
...
# RMSE : 22118.413146021652 , 7.353114733508009
...
################################################################
# Plot the order of the features using the feature_importance function, which indicates the importance of the variables.
################################################################
...
# Create a dataframe suitable for submitting to the Kaggle page. (Id, SalePrice)
########################################
